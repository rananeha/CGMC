			   ...
			   const REAL rot[3][3], const REAL trans[3])
{
  REAL T[3];
  REAL R[3][3];
  //std::cout << "Till here, everything's fine" << std::endl;
  CRss * rss1 = (CRss*) this;
  CRss * rss2 = (CRss*) bv2;
  //std::cout << "Till here, everything's fine" << std::endl;
  ...
  //std::cout << m_pos[0] << m_pos[1] << m_pos[2] << std::endl;
  
  //std::cout << rot[0][0] << rot[0][1] << rot[0][2] << std::endl;
  //std::cout << rss2->m_pos[0] << rss2->m_pos[1] << rss2->m_pos[2] << std::endl;

  //std::cout << rss1->m_orient[0][0] << rss1->m_orient[0][1] << rss1->m_orient[0][2] << std::endl;
  //std::cout << rss2->m_orient[0][0] << rss2->m_orient[0][1] << rss2->m_orient[0][2] << std::endl;
